...
class HomeVC: UIViewController {
    ...
    @IBOutlet weak var lblTAppTitle: UILabel!
    @IBOutlet weak var lblWelcomeField: UILabel!
    @IBOutlet weak var tableView: UITableView!

    override func viewDidLoad() {
        super.viewDidLoad()

          lblTAppTitle.text = "PropertyLinkUp"
          lblTAppTitle.textColor = UIColor.green
          lblTAppTitle.font = UIFont.boldSystemFont(ofSize: 24)
          lblTAppTitle.textAlignment = .center

          lblWelcomeField.text = "Welcome, \(loggedInUser?.name ?? "User")!"
          lblWelcomeField.textColor = UIColor.black
          lblWelcomeField.font = UIFont.systemFont(ofSize: 18)
          lblWelcomeField.textAlignment = .center

          // Set the table view appearance
